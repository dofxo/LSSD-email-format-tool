...
export const SEBInputs: FormatInputField[] = [
	...
	{ name: "operatorLastName", label: "Operator's last name", type: "text", formats: ["4", "6", "7", "10", "11", "12", "13"] },
	{ name: "applicationDate", label: "Application submitted date", type: "date", dateStyle: "full", formats: ["4", "6", "7", "10", "11", "12", "13"] },
	{ name: "senderPosition", label: "Your position (e.g. Instructor, Training Division)", type: "text", formats: ["4", "5", "6", "7", "10", "11", "12", "13"] },
